...
class Appointment(Base):
    ...
    service_price_amount: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    discount_amount: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    final_price_amount: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False, default=0)
    applied_benefit_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("client_benefits.id"), nullable=True)
